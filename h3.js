...
app.get("/dbs", (req, res) => {
  var db_config = require("./js/database.js");
...
app.get("/freenote", (req, res) => {
  fs.readFile("./html/freenote.html", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/uber", (req, res) => {
  fs.readFile("./js/uber.js", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/uber2", (req, res) => {
  fs.readFile("./js/uber2.js", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/loaddb", (req, res) => {
  fs.readFile("./js/loaddb.js", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/freenotecss", (req, res) => {
  fs.readFile("./css/freenote.css", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/aboutcss", (req, res) => {
  fs.readFile("./css/about.css", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/Gps_frequency", (req, res) => {
  fs.readFile("./poirec/Gps_frequency.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/uberh3", (req, res) => {
  fs.readFile("./poirec/uberh3.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all3", (req, res) => {
  fs.readFile("./전체따릉이/전체3.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all5", (req, res) => {
  fs.readFile("./전체따릉이/전체5.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all6", (req, res) => {
  fs.readFile("./전체따릉이/전체6.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all13", (req, res) => {
  fs.readFile("./전체따릉이/전체13.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all14", (req, res) => {
  fs.readFile("./전체따릉이/전체14.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all17", (req, res) => {
  fs.readFile("./전체따릉이/전체17.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all18", (req, res) => {
  fs.readFile("./전체따릉이/전체18.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all22", (req, res) => {
  fs.readFile("./전체따릉이/전체22.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all23", (req, res) => {
  fs.readFile("./전체따릉이/전체23.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all24", (req, res) => {
  fs.readFile("./전체따릉이/전체24.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all25", (req, res) => {
  fs.readFile("./전체따릉이/전체25.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all26", (req, res) => {
  fs.readFile("./전체따릉이/전체26.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all27", (req, res) => {
  fs.readFile("./전체따릉이/전체27.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/all28", (req, res) => {
  fs.readFile("./전체따릉이/전체28.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa1", (req, res) => {
  fs.readFile("./머문자리송파/d-송파1.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa2", (req, res) => {
  fs.readFile("./머문자리송파/d-송파2.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa3", (req, res) => {
  fs.readFile("./머문자리송파/d-송파3.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa4", (req, res) => {
  fs.readFile("./머문자리송파/d-송파4.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa5", (req, res) => {
  fs.readFile("./머문자리송파/d-송파5.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa6", (req, res) => {
  fs.readFile("./머문자리송파/d-송파6.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa7", (req, res) => {
  fs.readFile("./머문자리송파/d-송파7.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa8", (req, res) => {
  fs.readFile("./머문자리송파/d-송파8.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa9", (req, res) => {
  fs.readFile("./머문자리송파/d-송파9.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa10", (req, res) => {
  fs.readFile("./머문자리송파/d-송파10.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa11", (req, res) => {
  fs.readFile("./머문자리송파/d-송파11.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa12", (req, res) => {
  fs.readFile("./머문자리송파/d-송파12.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa13", (req, res) => {
  fs.readFile("./머문자리송파/d-송파13.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa14", (req, res) => {
  fs.readFile("./머문자리송파/d-송파14.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-songpa15", (req, res) => {
  fs.readFile("./머문자리송파/d-송파15.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo1", (req, res) => {
  fs.readFile("./머문자리강서/d-강서1.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo2", (req, res) => {
  fs.readFile("./머문자리강서/d-강서2.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo3", (req, res) => {
  fs.readFile("./머문자리강서/d-강서3.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo4", (req, res) => {
  fs.readFile("./머문자리강서/d-강서4.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo5", (req, res) => {
  fs.readFile("./머문자리강서/d-강서5.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo6", (req, res) => {
  fs.readFile("./머문자리강서/d-강서6.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo7", (req, res) => {
  fs.readFile("./머문자리강서/d-강서7.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo8", (req, res) => {
  fs.readFile("./머문자리강서/d-강서8.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo9", (req, res) => {
  fs.readFile("./머문자리강서/d-강서9.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo10", (req, res) => {
  fs.readFile("./머문자리강서/d-강서10.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo11", (req, res) => {
  fs.readFile("./머문자리강서/d-강서11.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo12", (req, res) => {
  fs.readFile("./머문자리강서/d-강서12.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo13", (req, res) => {
  fs.readFile("./머문자리강서/d-강서13.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo14", (req, res) => {
  fs.readFile("./머문자리강서/d-강서14.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-gangseo15", (req, res) => {
  fs.readFile("./머문자리강서/d-강서15.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all1", (req, res) => {
  fs.readFile("./머문자리전체/d-전체1.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all2", (req, res) => {
  fs.readFile("./머문자리전체/d-전체2.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all3", (req, res) => {
  fs.readFile("./머문자리전체/d-전체3.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all4", (req, res) => {
  fs.readFile("./머문자리전체/d-전체4.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all5", (req, res) => {
  fs.readFile("./머문자리전체/d-전체5.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all6", (req, res) => {
  fs.readFile("./머문자리전체/d-전체6.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all7", (req, res) => {
  fs.readFile("./머문자리전체/d-전체7.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all8", (req, res) => {
  fs.readFile("./머문자리전체/d-전체8.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all9", (req, res) => {
  fs.readFile("./머문자리전체/d-전체9.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all10", (req, res) => {
  fs.readFile("./머문자리전체/d-전체10.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all11", (req, res) => {
  fs.readFile("./머문자리전체/d-전체11.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all12", (req, res) => {
  fs.readFile("./머문자리전체/d-전체12.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all13", (req, res) => {
  fs.readFile("./머문자리전체/d-전체13.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all14", (req, res) => {
  fs.readFile("./머문자리전체/d-전체14.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all15", (req, res) => {
  fs.readFile("./머문자리전체/d-전체15.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all16", (req, res) => {
  fs.readFile("./머문자리전체/d-전체16.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all17", (req, res) => {
  fs.readFile("./머문자리전체/d-전체17.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all18", (req, res) => {
  fs.readFile("./머문자리전체/d-전체18.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all19", (req, res) => {
  fs.readFile("./머문자리전체/d-전체19.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all20", (req, res) => {
  fs.readFile("./머문자리전체/d-전체20.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all21", (req, res) => {
  fs.readFile("./머문자리전체/d-전체21.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all22", (req, res) => {
  fs.readFile("./머문자리전체/d-전체22.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all23", (req, res) => {
  fs.readFile("./머문자리전체/d-전체23.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all24", (req, res) => {
  fs.readFile("./머문자리전체/d-전체24.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all25", (req, res) => {
  fs.readFile("./머문자리전체/d-전체25.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all26", (req, res) => {
  fs.readFile("./머문자리전체/d-전체26.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all27", (req, res) => {
  fs.readFile("./머문자리전체/d-전체27.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all28", (req, res) => {
  fs.readFile("./머문자리전체/d-전체28.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all29", (req, res) => {
  fs.readFile("./머문자리전체/d-전체29.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/d-all30", (req, res) => {
  fs.readFile("./머문자리전체/d-전체30.png", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
...
app.get("/map3dmap", (req, res) => {
  fs.readFile("./html/seoul_bike_h3_11.html", (err, data) => {
    if (err) {
      res.send("error");
    } else {
      res.writeHead(200, { "Content-Type": "text/html" });
